...
import com.example.datamovie.activity.DetailMovieActivity;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MovieAdapter.MyViewHolder holder, int position) {
        holder.titleMovie.setText(resultList.get(position).getTitle());
        holder.descriptionMovie.setText(resultList.get(position).getOverview());
